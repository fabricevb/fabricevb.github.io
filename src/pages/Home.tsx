...
export default function HomePage() {
  ...
  const descriptions: Record<Locale, string> = {
    en: "Fabrice Van Boeckel — data scientist in NLP, AI governance, and econometrics for legal and regulatory evidence, currently at the Court of Justice of the EU.",
